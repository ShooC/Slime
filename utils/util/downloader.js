...
let servers = ['en136', 'id4', 'en60', 'en61', 'en68']
/**
 ...
 function yta(url, resol = '128kbps', server = 'en154') { return yt(url, resol, 'mp3', resol.endsWith('kbps') ? resol.replace(/kbps/g, '') : resol, server) }
   ...
   * @param {String} server (avaiable: `id4`, `en60`, `en61`, `en68`)
   */
 function ytv(url, resol = '360p', server = 'en154') { return yt(url, resol, 'mp4', resol.endsWith('p') ? resol.replace(/p/g, '') : resol, server) }

export { ytv, yta, yt, ytIdRegex, snapsave, tikmateApp, servers }
